...
\section{Nos Résultats}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{0.5\textwidth}
            \centering
            \includegraphics[width=.4\linewidth]{visualisation3_1000_init.pdf}
            \caption{Image de notre simulation lorsque les objets sont à leurs positions originales}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.4\linewidth]{5sec.jpg}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.4\linewidth]{millieu.jpg}
            \caption{Vraie vie en 5s}
        \end{subfigure}
        \caption{A figure with two subfigures}
    \end{figure}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.4\linewidth]{visualisation3_1000_contact.pdf}
            \caption{Image de notre simulation lorsque les objets se touchent}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.4\linewidth]{45sec.jpg}
            \caption{Vraie vie en 5s}
        \end{subfigure}
        \caption{A figure with two subfigures}
    \end{figure}
