...
\section{Nos Résultats}
    ...
    \begin{figure}[!htb]
        \centering
        \includegraphics[width=0.5\textwidth]{visualisation3_1000_init.pdf}
        \caption{Image de notre simulation lorsque les objets sont à leurs positions originales}
        \label{fig:simul_init}
    \end{figure}
    \begin{figure}[!htb]
        \centering
        \includegraphics[width=0.5\textwidth]{visualisation3_1000_pres.pdf}
        \caption{Image de notre simulation lorsque les objets sont proches}
        \label{fig:simul_pres}
    \end{figure}
    \begin{figure}[!htb]
        \centering
        \includegraphics[width=0.5\textwidth]{visualisation3_1000_contact.pdf}
