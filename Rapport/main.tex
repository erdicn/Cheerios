...
\section{Méthodes numériques et algorithme}
    ...
    \subsection{Collisions}
        ...
        \subsubsection{Collision des bords}
            ...
            \end{wrapfigure}
            Pour les collisions de bord on a fait tel que si notre objet dépassait le bord de très peut nous inversions le vecteur vitesse par rapport a la normale. Et apres nous multiplions ce vecteur par un coefficient de collision, $0 \leq C_c \leq 1$, qui simule l’absorption de l'énergie a chaque collision. 
