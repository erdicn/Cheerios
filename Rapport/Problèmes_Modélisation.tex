...
% TODO en parler entre nous pour voir si on fait toute les preuves ou juste decrit le probleme car jai limpression le truc qu on va faire cest tres similaire a celui dans cheerios
    ...
    }    %    TODO      ^ les calculs ou les equations ???
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    JE TE LAISSE CETTE PARTIE MAIS FAIT AU PLUS SIMPLE, SURTOUT NIVEAU BESSEL, SULTAN LUI MEME A DIT QUE C'ETAIT POUR MASTER. MDR 
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[height = 0.5\textwidth]{Besselk1_K0.pdf}
