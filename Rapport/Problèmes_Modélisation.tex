\section{Le problème et notre modélisation}
    ...
    % TODO en parler entre nous pour voir si on fait toute les preuves ou juste decrit le probleme car jai limpression le truc qu on va faire cest tres similaire a celui dans cheerios
        ...
        De ici on a besoin des tension superficielle experimentale de chaque millieu ($\gamma_{SV, SL, LV}$) equation \ref{eq:cos_angle_contact} mais comme on a pas les valeurs experimentale pour chaque objet par rapport aux millieux 
        \begin{equation}
            \theta \simeq \pi - \arctan z_c^{'}
        \end{equation}
        Qui nous donne un aproxximati
        % \begin{equation}
