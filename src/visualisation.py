...
anim = animation.FuncAnimation(fig, animate, init_func=init, frames=[i for i in range(0, NT, 1000)]# TODO  ici si on decide de upload seulement tout les 1/100 dans le programme c ca va pas jusque a la fin
