...
anim = animation.FuncAnimation(fig, animate, init_func=init, frames= [i for i in range(0, len(T) ,  int(1/(dt*100))*10)]# TODO  ici si on decide de upload seulement tout les 1/100 dans le programme c ca va pas jusque a la fin
