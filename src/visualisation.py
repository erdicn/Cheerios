...
anim = animation.FuncAnimation(fig, animate, init_func=init, frames= [i for i in range(0, len(T) , 10000)]# TODO  ici si on decide de upload seulement tout les 1/100 dans le programme c ca va pas jusque a la fin
